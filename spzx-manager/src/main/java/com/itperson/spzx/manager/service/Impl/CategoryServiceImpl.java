...
import com.itperson.spzx.manager.listener.ExcelListener;
import com.itperson.spzx.manager.mapper.CategoryMapper;
import com.itperson.spzx.manager.service.CategoryService;
...
//                categoryExcelVo.setId(id);
            ...
            e.printStackTrace();
            throw new PersonException(ResultCodeEnum.DATA_ERROR);
        }
    }
